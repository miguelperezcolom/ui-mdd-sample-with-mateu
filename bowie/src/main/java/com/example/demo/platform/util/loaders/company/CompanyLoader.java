...
import com.example.demo.platform.util.dtos.Film;
import com.example.demo.platform.util.dtos.FilmList;
...
public class CompanyLoader implements Runnable {
    ...
    public void run() {
        ...
        FilmList people = mapper.readValue(new ClassPathResource("/data/films.json").getInputStream()
                , FilmList.class);
